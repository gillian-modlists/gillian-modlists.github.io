...
- [Kingdom Save Editor](../tools/#kingdom-save-editor)
...
=== "Kingdom Hearts Final Mix"
    ...
    * [Critical Mix](https://www.nexusmods.com/kingdomheartsfinalmix/mods/93)
        * :material-information-outline: A full overhaul with a fast KH2-style combat system. Revamps Sora's combos, keyblades, accessories, abilities, and much more.
...
=== "Kingdom Hearts Re: Chain of Memories"
    ...
    * [Final Mix Heartless Colors](https://www.nexusmods.com/kingdomheartsrechainofmemories/mods/6)
        * :material-information-outline: Replaces Heartless colors to match with the Final Mix releases the rest of the collection has.
    * [Remastered Soundtrack](https://www.nexusmods.com/kingdomheartsrechainofmemories/mods/15)
        * :material-information-outline: Replaces soundtrack to match with the remastered versions the rest of the collection has.
...
=== "Kingdom Hearts II Final Mix"
    ...
    * [HD Models](https://www.nexusmods.com/kingdomhearts2finalmix/mods/120)
        * :material-information-outline: Uses textures from the HD Textures mod.
    ...
    * [Copyright Screen Skip](https://www.nexusmods.com/kingdomhearts2finalmix/mods/128)
        * :material-information-outline: [Quicker Copyright Screen](https://www.nexusmods.com/kingdomhearts2finalmix/mods/93) can be used instead.
=== "Kingdom Hearts Birth by Sleep Final Mix"
    ...
    * [Ultimate Mix](https://www.nexusmods.com/kingdomheartsbirthbysleepfinalmix/mods/25)
        * :material-information-outline: Huge overhaul mod for Birth by Sleep.
